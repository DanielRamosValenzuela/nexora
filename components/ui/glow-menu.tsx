...
export const MenuBar = React.forwardRef<HTMLDivElement, MenuBarProps>(
  ({ className, items, activeItem, onItemClick }, ref) => {
    return (
      ...
      >
        <motion.div
          className="absolute -inset-2 bg-gradient-radial from-transparent via-teal/20 via-30% via-cyan-400/15 via-60% via-teal-light/10 via-90% to-transparent rounded-3xl z-0 pointer-events-none"
